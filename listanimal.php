...
$table = $objAnimal->pesquisar($_GET);
...
<?php 
	...
	<div class="img1">
	<div class="col-sm-4">
	<img src="<?php echo $linha['foto'];?>" alt="Imagem como Thumbnail" class="img-responsive" width="304" height="304">  <P>   </P><br>
	<a href="http://localhost/PCC/animal_select.php?cod_animal=<?php echo $linha['cod_animal']?>"class ="textos">RAÇA : <?php echo $linha['raca'];?>
	   ...
	   //DATA : <?php echo $linha['data_status'];?></a>
	</div>
	</div>
<?php	 
} /*
